...
public class RuleSnapshotTest {
    ...
    public void copiesRulesAndExposesTierLimits() {
        ...
        RuleSnapshot snapshot = RuleSnapshot.create(4L, 1, 2, 3, 4, false,
                whitelist, Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
        whitelist.clear();
    ...
    public void rejectsOutOfRangePlacementLimit() {
        RuleSnapshot.create(1L, 0, 2, 3, 4, false,
    ...
    public void rejectsOversizedRuleValue() {
        RuleSnapshot.create(1L, 1, 2, 3, 4, false,
                Collections.singletonList(repeat('x', RuleSnapshot.MAX_RULE_BYTES + 1)),
