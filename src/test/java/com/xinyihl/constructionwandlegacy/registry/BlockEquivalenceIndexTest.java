...
public class BlockEquivalenceIndexTest {
    ...
    public void overlappingGroupsPreserveLegacyNonTransitiveRelationships() {
        BlockEquivalenceIndex index = BlockEquivalenceIndex.compile(new String[]{
                id(Items.DIAMOND) + ";" + id(Items.EMERALD),
                id(Items.EMERALD) + ";" + id(Items.IRON_INGOT)
        }, ignored -> { });
    ...
    public void duplicateIdsAreCollapsedAndTheSourceItemIsExcluded() {
        BlockEquivalenceIndex index = BlockEquivalenceIndex.compile(new String[]{
                id(Items.DIAMOND) + ";" + id(Items.DIAMOND) + ";" + id(Items.EMERALD)
        }, ignored -> { });
    ...
    public void invalidEntriesAreReportedWithoutDiscardingValidGroupMembers() {
        ...
        BlockEquivalenceIndex index = BlockEquivalenceIndex.compile(new String[]{
                id(Items.DIAMOND) + ";;test:missing_item;not a valid id;" + id(Items.EMERALD),
                null,
                ""
        }, warnings::add);
    ...
    public void blockMatchingUsesCompiledItemRelationshipAndRejectsAir() {
        BlockEquivalenceIndex index = BlockEquivalenceIndex.compile(new String[]{
                id(Item.getItemFromBlock(Blocks.STONE)) + ";" + id(Item.getItemFromBlock(Blocks.COBBLESTONE))
        }, ignored -> { });
